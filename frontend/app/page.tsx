...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950">
        ...
        <div className="grid gap-8 md:grid-cols-2 md:gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-gray-400 max-w-[600px]">
              AadharX is a decentralized identity system built with blockchain
              and zero-knowledge proofs, protecting your data while enabling
              secure verification.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link href="#how-it-works">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-none text-gray-300 bg-transparent hover:bg-gray-800 hover:text-white"
                >
                  Learn More
                </Button>
              </Link>
      ...
      <section id="features" className="container py-12 md:py-24">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-[800px] mx-auto">
            AadharX combines cutting-edge blockchain technology with
            zero-knowledge proofs to revolutionize identity verification
          </p>
        </div>
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400">
              Verify your identity without revealing sensitive personal data,
          ...
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400">
              Your identity is secured by immutable blockchain technology,
          ...
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-6 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400">
              Share your verifiable proofs instantly via QR codes for seamless
              verification.
            </p>
          </div>
        </div>
      ...
      <section
        id="how-it-works"
        className="py-12 md:py-24 bg-gray-950/80 border-y border-gray-800/40"
      >
        <div className="container">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-[800px] mx-auto">
              A simple, secure process for identity verification without
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="relative">
              ...
              <div className="mt-4 ml-12 md:ml-0">
                ...
                <p className="text-gray-400">
                  Visit an authorized center to register your identity securely
                  on the blockchain.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="mt-4 ml-12 md:ml-0">
                ...
                <p className="text-gray-400">
                  Create verifiable proofs of your identity without revealing
                  your personal data.
                </p>
              </div>
            </div>
            <div className="relative">
              ...
              <div className="mt-4 ml-12 md:ml-0">
                ...
                <p className="text-gray-400">
                  Share your proof via QR code with verifiers who can instantly
      ...
      <section id="modules" className="container py-12 md:py-24">
        <div className="text-center space-y-4 mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-[800px] mx-auto">
            Our platform serves different roles in the identity verification
            ecosystem
          </p>
        </div>
        <div className="grid gap-8 md:grid-cols-3">
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-8 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400 mb-4">
              For individuals who need to verify their identity while
              maintaining privacy.
            </p>
          ...
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-8 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400 mb-4">
              For organizations that need to verify identities without accessing
              sensitive data.
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center">
          ...
          <div className="group relative overflow-hidden rounded-xl border border-gray-800/50 bg-gray-900/30 p-8 backdrop-blur-sm transition-all hover:border-blue-500/50 hover:bg-gray-900/50">
            ...
            <p className="text-gray-400 mb-4">
              For authorized centers that register and manage identities on the
              blockchain.
            </p>
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center">
          ...
          <div className="grid gap-8 md:grid-cols-2 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-400">
                AadharX is built with privacy and security as core principles.
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Your personal data is never exposed during verification.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Once registered, your identity cannot be tampered with.
                    </p>
                  </div>
                </li>
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      All communications are encrypted to prevent interception.
                    </p>
                  </div>
                </li>
              </ul>
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-800/50 bg-gray-900/30 backdrop-blur-md">
          ...
          <div className="relative z-10 px-6 py-12 md:px-12 md:py-16 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-[800px] mx-auto mb-8">
              Join AadharX today and take control of your digital identity with
              blockchain-powered security and zero-knowledge privacy.
            </p>
        ...
        <div className="container py-12">
          <div className="grid gap-8 md:grid-cols-4">
            <div className="space-y-4">
              ...
              <p className="text-gray-400">
                Decentralized identity verification system built with blockchain
          ...
          <div className="mt-12 pt-8 border-t border-gray-800/40 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} AadharX. All rights reserved.
            </p>
